...
define([
    ...
    var initialize = async function () {
        ...
        configDisplay.innerHTML = `Cores: ${sessionStorage.getItem("cluster_data") ? JSON.parse(sessionStorage.getItem("cluster_data"))['spark.driver.cores'] : 'N/A'} | Memory : ${sessionStorage.getItem("cluster_data") ? JSON.parse(sessionStorage.getItem("cluster_data"))['spark.driver.memory'] : 'N/A'}`
            ...
            updateConfigButton.onclick = async function () {
                ...
                try {
                    ...
                    comm.on_msg(function (msg) {
                        ...
                        console.log("UPDATE COMM CONNECTED ", msg)
                        document.getElementById("config_display").innerHTML = `Cores: ${sessionStorage.getItem("cluster_data") ? JSON.parse(sessionStorage.getItem("cluster_data"))['spark.driver.cores'] : 'N/A'} | Memory : ${sessionStorage.getItem("cluster_data") ? JSON.parse(sessionStorage.getItem("cluster_data"))['spark.driver.memory'] : 'N/A'}`
